...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2024 a las 06:10:52
...
INSERT INTO `testablecimientos` (`idEstablecimientos`, `descripcion`, `tamaño`) VALUES
('EAUTOSGRANDESWGS', 'Vehículos de mayor tamaño como por ejemplo: buses o camiones.', 2),
('EAUTOSWGS', 'Vehículos pequeños como por ejemplo: carros o camionetas.', 1),
('ECASAGRANDEWGS', 'Casas o apartamentos grandes o de más de un piso.', 2),
('ECASASWGS', 'Casas y apartamentos pequeños o de un solo piso.', 1),
('ELOCALGRANDEWGS', 'Locales de un tamaño mayor o con más de un piso.', 2),
('ELOCALWGS', 'Locales pequeños o de un solo piso.', 1);
...
('100880027079409670', 'SCUCARACHASWGS', 'ECASASWGS', 30),
('100880027079409671', 'SRATASWGS', 'ECASASWGS', 25),
('100880027079409672', 'STERMITASWGS', 'ECASASWGS', 60),
('100880027079409673', 'SPULGASWGS', 'ECASASWGS', 80),
('100880027079409674', 'SZANCUDOSWGS', 'ECASASWGS', 35),
('100880027079409675', 'SCIENPIESWGS', 'ECASASWGS', 70),
('100880027079409676', 'SCUCARACHASWGS', 'EAUTOSWGS', 25),
('100880027079409677', 'SRATASWGS', 'EAUTOSWGS', 30),
('100880027079409678', 'STERMITASWGS', 'EAUTOSWGS', 40),
('100880027079409679', 'SPULGASWGS', 'EAUTOSWGS', 50);
...
('INPLCHPE15PR', 'Insecticida Plagatox Chiripas Pequeño 15', 'assets/img/uploads/images.jpg.jpg', 'asdasdasdasdasdasdadasdasdasd', 1);
...
CREATE TABLE `tservicios` (
  ...
  `descripcion` longtext COLLATE utf8mb4_spanish_ci NOT NULL,
  `fotoServicio` varchar(500) COLLATE utf8mb4_spanish_ci NOT NULL,
...
(0, 'SCUCARACHASWGS', '28150010'),
(1, 'SCIENPIESWGS', '28150010'),
(2, 'SRATASWGS', '28150010');
...
('josbertjg@gmail.com', '', 'Josbert', 'Guedez', '', 'assets/img/perfil/josbertjg@gmail.com.jpg', 1, 'gmail_oauth', 'FGWGS1', '2024-06-10 04:23:29', 1),
...
('workglobalserviceca@gmail.com', '', 'Josnel', 'Guedez', '', 'https://lh3.googleusercontent.com/a/ACg8ocJ7XYRMlybwZhYlo0ebVr57DV1ETJMQZnJR6vzAX3tkSr0YNQ=s96-c', 1, 'gmail_oauth', 'CLWGS1', '2024-06-10 04:23:41', 1);
